...
>(({ className, children, ...props }, ref) => (
  <DialogPortal data-slot="dialog-portal">
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed left-[50%] top-4 z-[60] grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] gap-4 rounded-lg bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:top-[50%] sm:max-w-lg sm:translate-y-[-50%]",
        className,
      )}
      {...props}
    >
